 ...
 * @return NULL se qualcosa e` andato storto nella creazione della lista
 */
List *createList();
 ...
 * @return 0 Qualcosa e` andato storto nell'inserimento
 */
 ...
 * @return NULL se qualcosa e` andato storto (e.g. L'indice e` non e` valido)
 */
